...
data = pd.read_csv("/content/Iris.csv") #"/content/Iris.csv" is the path of the csv file
print(data)  #  Getting glimpse of whole data for understanding
...
print(data.info())
print(data.describe()) #gives the statistical info
...
sns.countplot(x='Species', data=data, palette="plasma")
plt.title("Species Distribution")
plt.show()
sns.countplot(x='sepal_length', data=data, palette="plasma", hue='Species')
plt.title("Sepal Length Distribution")
plt.show()
plt.figure(figsize=(10,7))
sns.boxplot(x='Species', y='sepal_length', data=data, palette="plasma")
plt.title("Boxplot of Sepal length by Species")
plt.show()
sns.boxplot(x='Species', y='sepal_width', data=data, palette="plasma")
plt.title("Boxplot of Sepal width by Species")
plt.show()
sns.boxplot(x='Species', y='petal_length', data=data ,palette='plasma')
plt.title("Boxplot of Petal length by Species")
plt.show()
sns.boxplot(x='Species', y='petal_width', data=data ,palette='plasma')
plt.title("Boxplot of Petal width by Species")
plt.show()
sns.violinplot(x='Species', y='petal_length', data=data, palette="plasma")
